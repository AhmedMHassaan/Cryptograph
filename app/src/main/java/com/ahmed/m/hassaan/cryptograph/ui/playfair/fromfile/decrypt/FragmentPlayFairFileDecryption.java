...
package com.ahmed.m.hassaan.cryptograph.ui.playfair.fromfile.decrypt;
...
import com.ahmed.m.hassaan.cryptograph.databinding.FragmentPlayFairFileDecryptionBinding;
...
public class FragmentPlayFairFileDecryption extends Fragment implements View.OnClickListener {


    FragmentPlayFairFileDecryptionBinding binding;
    ...
    public FragmentPlayFairFileDecryption() {
    }
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPlayFairFileDecryptionBinding.inflate(inflater, container, false);
        events();
    ...
    public void onClick(View v) {
        if (v == binding.btnChooseFile) {
            chooseFile();
        } else if (v == binding.btnDecrypt) {
            if (isTreReadFile) {
                decryptFile(binding.lblFileResult.getText().toString());
            } else {
    ...
    private void readFile(Uri data) {
        try {
            ...
            isTreReadFile = true;
            binding.btnDecrypt.setVisibility(View.VISIBLE);
            ...
            binding.btnDecrypt.setVisibility(View.GONE);
            binding.btnChooseFile.setVisibility(View.VISIBLE);
            isTreReadFile = false;
        }
    }

    private void decryptFile(String fileContent) {

        caesarViewModel.decrypt(5, fileContent);
    }
...
//            }
            ...
            File outPut = new File(mainDir.getPath() + "/decFile.txt");
